...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
    ...
    config.vm.define "core" do |core|
        core.vm.host_name = "boilerplate.andreas-weber.dev"
        core.vm.network "private_network", ip: "192.168.49.101"

        core.vm.provider :virtualbox do |virtualbox|
            virtualbox.customize ["modifyvm", :id, "--name", "boilerplate.andreas-weber.dev"]
        end
    end
